...
ae_type1 %>%
  ...
  head(10) %>%
  kable()
write_csv(ae_type1, here("RefData", "ae_type1.csv"))
```
...
```
## Getting Top 10 hospitals with most attendances and saving for record
```{r i,message = FALSE, warning = FALSE}
Type1_att_ascending <-Type1_attendances[order(-Type1_attendances$attendances),]
glimpse(Type1_att_ascending)
write_csv(Type1_att_ascending, here("RefData", "Type1_attendances_ascending.csv"))
```
